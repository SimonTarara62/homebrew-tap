class FundamentalsMcp < Formula
  include Language::Python::Virtualenv

  desc "Unofficial MCP server for read-only fundamentals, macro & news data"
  homepage "https://github.com/SimonTarara62/fundamentals-mcp"
  url "https://files.pythonhosted.org/packages/5b/2a/41532b96357e9e487951a1d974991239ec1e4e8cf3415ede7cfc0fec3ff1/fundamentals_mcp-0.1.0.tar.gz"
